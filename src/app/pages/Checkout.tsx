...
export default function Checkout({ onBack, onSuccess }: CheckoutProps) {
  ...
  return (
    <form
      ...
      dir="rtl"
      lang="ar"
      className="relative min-h-screen overflow-hidden bg-[radial-gradient(circle_at_top_right,_rgba(22,184,190,0.16),_transparent_32%),linear-gradient(180deg,#F8FEFF_0%,#EEF9FA_100%)] px-4 py-8 text-[#073B3F]"
    >
      {/* خلفية متحركة خاصة بهوية 3D TECH */}
      <div className="pointer-events-none absolute inset-0 overflow-hidden" aria-hidden="true">
        {[
          { x: '7%', y: '12%', size: 10, delay: 0, duration: 6 },
          { x: '18%', y: '72%', size: 7, delay: 1.2, duration: 7 },
          { x: '35%', y: '18%', size: 6, delay: 0.7, duration: 5.5 },
          { x: '52%', y: '82%', size: 9, delay: 1.8, duration: 6.5 },
          { x: '70%', y: '20%', size: 7, delay: 0.4, duration: 7.5 },
          { x: '86%', y: '66%', size: 11, delay: 1, duration: 6.8 },
          { x: '94%', y: '28%', size: 5, delay: 2, duration: 5.8 },
        ].map((dot, index) => (
          <motion.span
            key={index}
            className="absolute rounded-full bg-[#16B8BE]/30 shadow-[0_0_24px_rgba(22,184,190,0.28)]"
            style={{
              left: dot.x,
              top: dot.y,
              width: dot.size,
            ...
            animate={{ y: [0, -18, 0], opacity: [0.25, 0.75, 0.25], scale: [1, 1.25, 1] }}
            transition={{
      ...
      <div className="relative z-10 mx-auto max-w-6xl">
        <div className="mb-8 flex items-center gap-2 cursor-pointer" onClick={onBack}>
          <ChevronRight className="text-[#073B3F]" />
          <span className="font-semibold text-[#073B3F]">
            العودة للسلة
          </span>
        </div>

        <div className="mb-10 text-center">
          <span className="mb-3 inline-flex items-center rounded-full border border-[#16B8BE]/25 bg-white/80 px-4 py-2 text-xs font-bold tracking-[0.18em] text-[#0B777B] shadow-sm backdrop-blur">
            3D TECH • CHECKOUT
          </span>
          <h1 className="text-3xl font-black text-[#073B3F] sm:text-4xl">إتمام الطلب</h1>
          <p className="mt-3 text-sm text-[#55777A]">أكمل بياناتك واختر طريقة الشحن والدفع المناسبة</p>
        </div>

        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8 items-start">
          <div className="lg:col-span-2 space-y-6">
            <div className="rounded-[28px] border border-white/80 bg-white/85 p-6 shadow-[0_18px_55px_rgba(7,59,63,0.08)] backdrop-blur-xl sm:p-8">
              <h2 className="text-2xl font-bold mb-6 text-[#073B3F]">معلومات العميل</h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <input
                  ...
                  className="w-full px-4 py-3 border border-[#C7E5E7] rounded-2xl text-[#073B3F] bg-[#FFFFFF] placeholder:text-gray-400 outline-none focus:border-[#073B3F]"
                ...
                <input
                  ...
                  className="w-full px-4 py-3 border border-[#C7E5E7] rounded-2xl text-[#073B3F] bg-[#EDF8F9] outline-none"
                />
                ...
                >
                  <SelectTrigger 
                    className="!w-full !h-[50px] !px-4 !py-3 !border !border-[#C7E5E7] !rounded-2xl !bg-[#EDF8F9] !text-[#073B3F] !shadow-none !outline-none !ring-0 focus:!border-[#073B3F] focus:!ring-0 flex items-center justify-between text-right [&_svg]:size-[18px] [&_svg]:text-[#628184]"
                  >
                    <SelectValue placeholder="اختر المحافظة" />
                  </SelectTrigger>
                  <SelectContent
                    position="popper"
                    className="rounded-[28px] border border-[#CFEAEC] bg-[#FFFFFF] p-2 shadow-[0_16px_34px_rgba(15,58,43,0.10)]"
                  >
                    {Object.keys(governorateToWilayah).map(governorate => (
                      <SelectItem
                        key={governorate}
                        value={governorate}
                        className="mb-1 min-h-[46px] rounded-2xl px-4 py-3 text-[15px] font-medium text-[#073B3F] outline-none transition data-[highlighted]:bg-[#073B3F] data-[highlighted]:text-[#FFFFFF] data-[state=checked]:bg-[#073B3F] data-[state=checked]:text-[#FFFFFF] last:mb-0"
                      >
                        {governorate}
                      </SelectItem>
                    ))}
                ...
                <textarea
                  ...
                  onChange={handleInputChange}
                  className="md:col-span-2 w-full px-4 py-3 border border-[#C7E5E7] rounded-2xl resize-none text-[#073B3F] bg-[#FFFFFF] placeholder:text-gray-400 outline-none focus:border-[#073B3F]"
                  rows={2}
            ...
            <div className="rounded-[28px] border border-white/80 bg-white/85 p-6 shadow-[0_18px_55px_rgba(7,59,63,0.08)] backdrop-blur-xl sm:p-8">
              <h2 className="text-2xl font-bold mb-6 text-[#073B3F]">طرق الشحن</h2>
                  ...
                  return (
                    <label
                      ...
                      className={`rounded-2xl border-2 px-5 py-5 cursor-pointer transition-all duration-200 ${
                        isSelected
                          ? 'border-[#073B3F] bg-[#E6F7F8] shadow-[0_8px_20px_rgba(15,58,43,0.08)]'
                          : 'border-[#C7E5E7] bg-[#FAFEFE] hover:border-[#7ED4D8] hover:shadow-[0_4px_12px_rgba(15,58,43,0.06)]'
                      }`}
                    >
                      <div className="flex items-start justify-between gap-3 mb-3">
                        <div className="flex items-center gap-3">
                          <span
                            className={`inline-flex items-center justify-center w-10 h-10 rounded-xl border ${
                              isSelected
                                ? 'border-[#073B3F] bg-[#073B3F] text-white'
                                : 'border-[#B6DFE2] bg-white text-[#073B3F]'
                            }`}
                          >
                            {option.key === 'office' ? <Building2 className="w-5 h-5" /> : <House className="w-5 h-5" />}
                          </span>
                          <span className="font-bold text-[15px] text-[#073B3F]">{option.label}</span>
                        </div>
                        ...
                        <span
                          className={`mt-1 w-4 h-4 rounded-full border-2 flex-shrink-0 flex items-center justify-center ${
                            isSelected
                              ? 'border-[#073B3F] bg-[#073B3F]'
                              : 'border-[#8CB6B9] bg-white'
                          }`}
                        >
                      ...
                      {option.duration && (
                        <p className="text-sm text-[#456A6D]">مدة التوصيل: {option.duration}</p>
                      )}
                    </label>
                  );
                })}
            ...
            <div className="rounded-[28px] border border-white/80 bg-white/85 p-6 shadow-[0_18px_55px_rgba(7,59,63,0.08)] backdrop-blur-xl sm:p-8">
              <h2 className="text-2xl font-bold mb-6 text-[#073B3F]">طريقة الدفع</h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                <div
                  ...
                  className={`rounded-2xl border-2 px-5 py-4 flex items-center justify-between cursor-pointer transition-all duration-200 ${
                    paymentMethod === 'bank_transfer'
                      ? 'border-[#073B3F] bg-[#E6F7F8] shadow-[0_8px_20px_rgba(15,58,43,0.08)]'
                      : 'border-[#C7E5E7] bg-[#FAFEFE] hover:border-[#7ED4D8]'
                  }`}
                >
                  <span className="font-bold text-[15px]">تحويل بنكي</span>
                  <span
                    className={`w-4 h-4 rounded-full border-2 flex items-center justify-center ${
                      paymentMethod === 'bank_transfer' ? 'border-[#073B3F] bg-[#073B3F]' : 'border-[#8CB6B9]'
                    }`}
                  >
                ...
                >
                  ...
                  <span
                    className={`w-4 h-4 rounded-full border-2 flex items-center justify-center ${
                      paymentMethod === 'cash_on_delivery' ? 'border-[#073B3F] bg-[#073B3F]' : 'border-[#8CB6B9]'
                    }`}
                  >
              ...
              <div className="rounded-2xl border border-[#CFE8EA] bg-[#EAF8F9] p-5 mb-6 text-[#073B3F]">
                <div className="flex items-center justify-between mb-4">
                  <span className="font-semibold text-lg">
                    {paymentMethod === 'bank_transfer' ? 'تحويل بنكي' : 'الدفع عند الاستلام'}
                  </span>
                  <span aria-label="طريقة دفع يدوية عبر التحويل البنكي" className="text-sm bg-[#073B3F] text-white px-3 py-1 rounded-full">يدوي</span>
                </div>
                ...
                <div className="space-y-3 text-sm">
                  ...
                  {bankInfo.bank_payment_instructions && (
                    <p className="text-sm text-[#527477] pt-2 border-t border-[#CFE8EA] mt-2">
                      {bankInfo.bank_payment_instructions}
                    </p>
                  )}
                </div>
              ...
              <div
                className={`border-2 border-dashed rounded-2xl p-8 text-center cursor-pointer transition ${
                  dragActive ? 'bg-[#EAF8F9] border-[#073B3F]' : 'bg-[#FFFFFF] border-[#CFE8EA]'
                }`}
              ...
              >
                ...
                <label htmlFor="receipt-upload" className="cursor-pointer flex flex-col items-center text-[#073B3F]">
                  <Upload className="w-10 h-10 mb-3 text-[#073B3F]" />
                  <span className="font-semibold text-[#073B3F]">
                    {receiptFileName 
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-24 rounded-[28px] border border-white/80 bg-white/90 p-6 shadow-[0_18px_55px_rgba(7,59,63,0.10)] backdrop-blur-xl sm:p-8">
              <h2 className="text-2xl font-bold mb-6 text-[#073B3F]">ملخص الطلب</h2>

              <div className="space-y-4 mb-6 text-[#073B3F]">
                    ...
                    <div className="flex items-center gap-3 min-w-0">
                      {item.image ? (
                        <img
                          ...
                          className="w-14 h-14 rounded-xl object-cover border border-[#CFE8EA] bg-[#EDF8F9]"
                        />
                      ) : (
                        <div className="flex h-14 w-14 items-center justify-center rounded-xl border border-[#CFE8EA] bg-[#EDF8F9] text-xs font-bold">
                          مزاد
                        </div>
                      )}
                ...
                <div className="rounded-2xl border border-[#CFE8EA] bg-[#EAF8F9] p-4 mb-5">
  ...
  <div className="flex gap-2">
    <input
      ...
      className="flex-1 px-3 py-2 border border-[#BFE1E3] rounded-xl bg-white outline-none focus:border-[#073B3F]"
    ...
    <button
      ...
      className="px-4 py-2 rounded-xl bg-[#073B3F] text-white font-semibold disabled:opacity-60"
    >
  ...
  <span>-{formatPrice(discountAmount)}</span>
              ...
              <button
                ...
                style={{ background: 'linear-gradient(135deg, #16B8BE 0%, #0F8F94 100%)', color: '#FFFFFF', boxShadow: '0 14px 34px rgba(22, 184, 190, 0.28)' }}
              >
                تأكيد الطلب
              </button>
            </div>
